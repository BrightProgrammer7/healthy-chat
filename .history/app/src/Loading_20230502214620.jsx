...
function LoadingPage() {
  ...
  const [remainingTime, setRemainingTime] = useState(10); // Durée du jeu en millisecondes
  const [maxSquares, setMaxSquares] = useState(20); // Nombre maximum de carrés à faire disparaître
